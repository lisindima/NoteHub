...
//  NoteHub (watch) WatchKit Extension
//
//  Created by Дмитрий Лисин on 06.01.2021.
//
...
class ComplicationController: NSObject, CLKComplicationDataSource {
    ...
    func getComplicationDescriptors(handler: @escaping ([CLKComplicationDescriptor]) -> Void) {
        let descriptors = [
            CLKComplicationDescriptor(identifier: "complication", displayName: "NoteHub", supportedFamilies: CLKComplicationFamily.allCases),
